            ...
            @foreach($orders as $order)
                <tr data-expanded="true">
                    ...
                    <td>
                        ...
                        <a href="#" data-toggle="modal" data-id="{!! $order->id !!}" data-target="#deleteModal" class="btn btn-xs btn-danger delete {!! $order->status == 1 ? '' : 'deleteOrder' !!}"><i class="fa fa-trash"></i> Xoá</a>
