...
<div class="form-w3layouts">
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">THÊM BÀI VIẾT</header>
                <div class="panel-body">
                    <div class="position-center">
                        <form role="form" action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <img src="{{ asset('public/uploads/200x170.png') }}" class="thumbnail" width="200px" height="170px" id="anh_post" alt="ảnh slider">
                            </div>
                            <div class="form-group">
...
<script>
    ...
    $(document).on('change', 'input[name="feature_image_path"]', function(e) {
        ...
        $("#anh_post").fadeIn("fast").attr('src', tmppath);
    });
