...
<div class="hero-items owl-carousel">
    <div class="single-hero-items set-bg" data-setbg="{{asset('public/frontend/images/hero-1.jpg')}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <span>Bag,kids</span>
    ...
    <div class="single-hero-items set-bg" data-setbg="{{ asset('public/frontend/images/hero-2.jpg')}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <span>Bag,kids</span>
